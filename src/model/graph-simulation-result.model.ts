...
> {
    ...
    GraphSimulationResultModel.init(
      {
        ...
        tested_weight_simulation_result: {
          type: DataTypes.DECIMAL(12, 4),
          allowNull: false,
        },
        path_simulation_result: { type: DataTypes.JSONB, allowNull: false },
        path_cost_simulation_result: {
          type: DataTypes.DECIMAL(12, 4),
          allowNull: false,
        },
        execution_time_ms_simulation_result: {
          type: DataTypes.DECIMAL(12, 4),
          allowNull: false,
        },
        created_at_simulation_result: {
          type: DataTypes.DATE,
          allowNull: false,
      ...
      },
      {
        ...
        indexes: [
          ...
          {
            fields: ["path_cost_simulation_result"],
            name: "idx_gsr_best_cost",
          },
        ],
      },
    );
  ...
  static associate(models: any) {
    ...
    GraphSimulationResultModel.belongsTo(models.GraphSimulation, {
