...
> {
    ...
    GraphModel.init(
      ...
      },
      {
        ...
        indexes: [
          ...
          {
            unique: true,
            fields: ["id_owner_user", "name_model"],
            name: "uq_gm_owner_name",
          },
        ],
      },
    );
  ...
  static associate(models: any) {
    ...
    GraphModel.belongsTo(models.GraphUser, {
      foreignKey: "id_owner_user",
      as: "owner",
      onDelete: "CASCADE",
    });
    GraphModel.hasMany(models.GraphVersion, {
      foreignKey: "id_model",
      as: "versions",
      onDelete: "CASCADE",
    });
    GraphModel.hasMany(models.GraphWeightChangeRequest, {
      foreignKey: "id_model",
      as: "weightChangeRequests",
      onDelete: "CASCADE",
    });
    GraphModel.hasMany(models.GraphSimulation, {
      foreignKey: "id_model",
      as: "simulations",
      onDelete: "CASCADE",
    });
