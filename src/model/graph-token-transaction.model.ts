...
> {
    ...
    GraphTokenTransactionModel.init(
      {
        ...
        prev_tokens_token_transaction: {
          type: DataTypes.DECIMAL(12, 2),
          allowNull: false,
        },
        new_tokens_token_transaction: {
          type: DataTypes.DECIMAL(12, 2),
          allowNull: false,
        },
        diff_tokens_token_transaction: {
          type: DataTypes.DECIMAL(12, 2),
          allowNull: false,
        },
        reason_token_transaction: { type: DataTypes.TEXT, allowNull: true },
        created_at_token_transaction: {
          type: DataTypes.DATE,
          allowNull: false,
      ...
      },
      {
        ...
        indexes: [
          {
            fields: ["id_user", "created_at_token_transaction"],
            name: "idx_gtt_user_created_at",
          },
        ],
      },
    );
  ...
  static associate(models: any) {
    ...
    GraphTokenTransactionModel.belongsTo(models.GraphUser, {
      foreignKey: "id_user",
      as: "user",
      onDelete: "CASCADE",
    });
