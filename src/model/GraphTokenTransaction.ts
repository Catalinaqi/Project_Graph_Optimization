...
> {
    ...
    static initModel(sequelize: Sequelize): typeof GraphTokenTransaction {
        logger.debug("[GraphTokenTransaction] Initializing model...");
    ...
    static associate(models: any) {
        logger.debug("[GraphTokenTransaction] Registering associations...");

        GraphTokenTransaction.belongsTo(models.GraphUser, { foreignKey: "id_user", as: "user", onDelete: "CASCADE" });
        GraphTokenTransaction.belongsTo(models.GraphUser, { foreignKey: "id_performer_user", as: "performer", onDelete: "SET NULL" });
    }
}
