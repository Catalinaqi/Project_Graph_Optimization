...
> {
    ...
    static associate(models: any) {
        ...
        GraphSimulationModel.belongsTo(models.GraphModel, { foreignKey: "id_model", as: "model", onDelete: "CASCADE" });
        GraphSimulationModel.belongsTo(models.GraphUser, { foreignKey: "id_user", as: "user", onDelete: "RESTRICT" });
        GraphSimulationModel.hasMany(models.GraphSimulationResult, { foreignKey: "id_simulation", as: "results", onDelete: "CASCADE" });
    }
}
