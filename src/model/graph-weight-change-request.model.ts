/***
 GraphWeightChangeRequestModel Model
 *
...
export class GraphWeightChangeRequestModel extends Model<
  InferAttributes<GraphWeightChangeRequestModel>,
  InferCreationAttributes<GraphWeightChangeRequestModel>
> {
  ...
  static initModel(sequelize: Sequelize): typeof GraphWeightChangeRequestModel {
    logger.debug("[GraphWeightChangeRequestModel] Initializing model...");

    GraphWeightChangeRequestModel.init(
      {
      ...
      },
      {
        ...
        modelName: "GraphWeightChangeRequestModel",
        timestamps: false,
        indexes: [
          {
            fields: [
              ...
              "created_at_weight_change_request",
            ],
    ...
    return GraphWeightChangeRequestModel;
  }

  static associate(models: any) {
    logger.debug("[GraphWeightChangeRequestModel] Registering associations...");

    GraphWeightChangeRequestModel.belongsTo(models.GraphModel, {
      foreignKey: "id_model",
      as: "model",
      onDelete: "CASCADE",
    });
    GraphWeightChangeRequestModel.belongsTo(models.GraphUser, {
