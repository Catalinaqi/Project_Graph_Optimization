...
> {
    ...
    static initModel(sequelize: Sequelize): typeof GraphSimulationResult {
        logger.debug("[GraphSimulationResult] Initializing model...");
    ...
    static associate(models: any) {
        logger.debug("[GraphSimulationResult] Registering associations...");

        GraphSimulationResult.belongsTo(models.GraphSimulation, { foreignKey: "id_simulation", as: "simulation", onDelete: "CASCADE" });
    }
}
