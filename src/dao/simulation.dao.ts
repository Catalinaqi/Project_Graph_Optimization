...
export class SimulationDao implements SimulationIdao {
    async createSimulation(data: SimulationInput, opt?: Tx): Promise<GraphSimulationModel> {
        try {
            logger.debug(
    ...
    async createSimulationResult(data: SimulationResultInput, opt?: Tx): Promise<GraphSimulationResultModel> {
        try {
            logger.debug(
