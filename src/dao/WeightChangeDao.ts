import IWeightChangeDao from "./dao-interface/IWeightChangeDao";
import type { Tx } from "@/common/types";
import { GraphWeightChangeRequest } from "@/model/GraphWeightChangeRequest";
import { Op } from "sequelize";
import logger from "@/config/logger";
import { GraphRequestStatusEnum } from "@/common/enums";


const WeightChangeDao: IWeightChangeDao = {
    create(data, opt?: Tx) {
        logger.debug(
        ...
        return GraphWeightChangeRequest.create(
            {
                ...data,
    ...
    findById(requestId, opt?: Tx) {
        ...
        return GraphWeightChangeRequest.findByPk(requestId, { ...(opt || {}) });
    },
    ...
    list(modelId, filters, opt?: Tx) {
        ...
        return GraphWeightChangeRequest.findAll({
            where,
    ...
    approve(requestId, opt?: Tx) {
        ...
        // approve
        return GraphWeightChangeRequest.update(
