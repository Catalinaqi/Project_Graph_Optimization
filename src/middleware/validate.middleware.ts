 ...
 */
export function validationMiddlewareV2(config: ValidateConfig, opts?: MiddlewareOpts) {
    ...
    const validateOne = (schema: ObjectSchema, target: Target, req: Request) => {
        ...
        const jo = target === "headers" ? { ...base, allowUnknown: true, stripUnknown: false } : base;
